        ...
        public Curriculum Get()
        {
            return new Curriculum
            {
                ...
                SkillsParagraphs = new ParagraphList { 
                   ...
                   "I have also gained a moderate amount of experience building mobile apps with different technologies, including Monotouch and PhoneGap as cross-platform alternatives, and the native Windows Phone SDK for personal test projects.",
